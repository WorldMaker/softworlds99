...
<body background="images/yggbground.gif" text="#ffffff" link="yellow" alink="yellow" vlink="yellow">
...
<center><img src="images/ygglogo.jpg"><br>
<SMALL>Welcome to Yggdrasil Games!</SMALL></center>
...
<div id="barlayerDiv">
<table border=0 background="images/yggbartop.gif" width=100%><tr><td>
<script>
document.write(
...
<script>
document.write(
createHotLink("sw.html","&nbsp;SoftWorlds&nbsp;")+
createHotLink("javascript: myscroll.load('ygghome.htm')","&nbsp;Home&nbsp;")//+
)
</script>
</td><td align=right>
<script>
...
<div id="mylayerDiv"><img border=0 src="images/ygg.jpg"></div>

<div id="klixDiv">
	<table border=0 width=100%><tr><th background="images/yggtop.gif">
	<B>Yggdrasil</B>
	</th></tr><tr><td>
	<script src="yggmenu.js"></script>
	</td></tr>
</div>
